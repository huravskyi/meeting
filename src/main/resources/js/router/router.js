...
import ChatViewMessageMobile from "../pages/ChatViewMessageMobile.vue";
...
// const ChatViewMessageMobile  = () => import( "../pages/ChatViewMessageMobile.vue")
...
const routes = [
    ...
    {path: '/message/:id?', component: ChatViewMessageMobile, props: true},
